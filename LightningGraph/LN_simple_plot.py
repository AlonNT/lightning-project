...
def draw_save_lightning_graph(graph, path):
    plt.figure()
    nx.draw(graph)
...
def basic_graph_statistics(graph, plot_dir='basic_statistics_figs'): # TODO:  rewrite neatly or inspire from seaborn code of ayeletm02
    ...
    draw_save_lightning_graph(graph, "graph_arch.png")


if __name__ == '__main__':
    LN_graph = get_lightning_graph('old_dumps/LN_2020.05.13-08.00.01.json', total_capacity=True, infer_imp=True, compute_betweeness=False)
