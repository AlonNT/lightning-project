...
parser.add_argument('--SIMULATOR_TRANSFERS_MAX_AMOUNT', type=int, default=10 ** 6,
                    help='The maximal amount that can be transferred between two nodes.')
parser.add_argument('--LN_DEFAULT_CHANNEL_COST', type=int, default=4 * 10 ** 4,
...
parser.add_argument('--SIMULATOR_NUM_TRANSACTIONS', type=int, default=1000,
                    help='How many transaction the simulator will simulate.')
parser.add_argument('--NUMBER_REPEATED_SIMULATIONS', type=int, default=3,
                    help='How many times to repeat the experiment, in order to get the mean & std of the reward in each step..')
parser.add_argument('--SIMULATOR_NUM_NODES', type=int, default=30,
